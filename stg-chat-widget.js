(function() {
  ...
  function createWidget() {
    ...
    widget.innerHTML = `
        ...
        <div class="h-[500px] bg-white rounded-2xl shadow-[0px_12px_24px_0px_rgba(94,118,144,0.20)] border border-slate-200 flex flex-col overflow-hidden">
          ...
          <div class="px-4 pr-3 py-3 flex justify-start items-center gap-2">
            ...
            <div class="w-10 p-0.5 bg-slate-200 rounded-full flex justify-start items-center gap-2">
              <div class="w-5 h-5 bg-white rounded-full flex items-center justify-center cursor-pointer">
            ...
            <!-- Close Button -->
            <button id="blackorbit-close-btn" class="w-8 h-8 px-2 py-[5px] rounded-lg flex justify-center items-center hover:bg-slate-100 transition-colors">
          ...
          <div class="flex-1 flex">
            <div id="blackorbit-messages" class="flex-1 p-3 bg-white overflow-y-auto">
              <!-- Terms Banner -->
              <div id="blackorbit-terms-banner" class="bg-white border border-slate-200 rounded-lg p-4 text-center mt-20">
                ...
                <p class="text-slate-600 text-sm leading-relaxed">
                  ${CONFIG.termsMessage} <a href="${CONFIG.termsLinkUrl}" target="_blank" class="font-medium hover:underline" style="color: ${CONFIG.primaryColor};">${CONFIG.termsLinkText}</a>
                </p>
              </div>
            </div>
            ...
            <div class="w-full flex justify-start items-center gap-2">
              <div class="flex-1 h-10 p-2 bg-slate-100 rounded-lg border border-slate-200 flex items-center gap-2">
                <input 
                  ...
                  class="flex-1 bg-transparent text-slate-500 text-sm outline-none"
              ...
              <button id="blackorbit-send-btn" class="w-10 h-10 p-2 rounded-lg flex justify-center items-center" style="background-color: ${CONFIG.primaryColor};">
      ...
      <!-- Toggle Button -->
      <button id="blackorbit-toggle-btn" class="p-4 rounded-full shadow-[0px_12px_24px_0px_rgba(94,118,144,0.20)] flex justify-center items-center" style="background-color: ${CONFIG.primaryColor};">
  ...
  function initWidget() {
    ...
    function addMessage(content, isUser = false) {
      ...
      bubble.className = `max-w-[80%] px-3 py-2 rounded-xl text-sm ${
        isUser 
    ...
    console.log('BlackOrbit Widget initialized:', SESSION_ID);
  }
